...
//
#ifndef TINY_GLOBAL_H
#define TINY_GLOBAL_H
...
typedef struct
{
    ...
    //the value of TK_INT
    std::string s_val; 
    //the value of TK_STRING or TK_ID
} Token;
...
struct MidCode
{
    ...
    MidCode(CodeType type, const std::string &_s1, const std::string &_s2, const std::string &_t) : type(type)
    {
        s1 = _s1;
        s2 = _s2;
        t = _t;
